...
proc customlogicCreateProject {} {
	...
	set files [list \
		...
		"[file normalize "$customlogic_dir/04_ref_design/pix_threshold_pix_threshold_proc.vhd"]"\
		"[file normalize "$customlogic_dir/04_ref_design/pix_threshold_regslice_both.vhd"]"\
