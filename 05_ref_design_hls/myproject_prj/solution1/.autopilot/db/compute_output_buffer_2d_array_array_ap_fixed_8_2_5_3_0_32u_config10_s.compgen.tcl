...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer10_out_din { O 256 vector } layer10_out_num_data_valid { I 3 vector } layer10_out_fifo_cap { I 3 vector } layer10_out_full_n { I 1 bit } layer10_out_write { O 1 bit } } \
} "
}
