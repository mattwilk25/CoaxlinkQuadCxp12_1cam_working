...
entity myproject_fifo_w128_d49_A is
    generic (
...
architecture arch of myproject_fifo_w128_d49_A is

    -- component
    component myproject_fifo_w128_d49_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w128_d49_A_ram : myproject_fifo_w128_d49_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity myproject_fifo_w128_d49_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 128;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of myproject_fifo_w128_d49_A_ram is
