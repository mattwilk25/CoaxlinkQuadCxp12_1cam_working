set moduleName relu_array_ap_fixed_32u_array_ap_ufixed_8_2_4_0_0_32u_relu_config12_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {relu<array<ap_fixed,32u>,array<ap_ufixed<8,2,4,0,0>,32u>,relu_config12>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer10_out int 256 regular {fifo 0 volatile }  }
	{ layer12_out int 256 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer10_out_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ layer10_out_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ layer10_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer10_out_read sc_out sc_logic 1 signal 0 } 
	{ layer12_out_din sc_out sc_lv 256 signal 1 } 
	{ layer12_out_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ layer12_out_fifo_cap sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "layer12_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer10_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer10_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer12_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer10_out { ap_fifo {  { layer10_out_dout fifo_port_we 0 256 }  { layer10_out_num_data_valid fifo_status_num_data_valid 0 3 }  { layer10_out_fifo_cap fifo_update 0 3 }  { layer10_out_empty_n fifo_status 0 1 }  { layer10_out_read fifo_data 1 1 } } }
	layer12_out { ap_fifo {  { layer12_out_din fifo_port_we 1 256 }  { layer12_out_num_data_valid fifo_status_num_data_valid 0 3 }  { layer12_out_fifo_cap fifo_update 0 3 }  { layer12_out_full_n fifo_status 0 1 }  { layer12_out_write fifo_data 1 1 } } }
}
