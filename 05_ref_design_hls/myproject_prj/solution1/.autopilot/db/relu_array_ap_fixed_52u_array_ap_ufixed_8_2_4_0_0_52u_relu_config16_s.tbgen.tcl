set moduleName relu_array_ap_fixed_52u_array_ap_ufixed_8_2_4_0_0_52u_relu_config16_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {relu<array<ap_fixed,52u>,array<ap_ufixed<8,2,4,0,0>,52u>,relu_config16>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer14_out int 416 regular {fifo 0 volatile }  }
	{ layer16_out int 416 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer14_out", "interface" : "fifo", "bitwidth" : 416, "direction" : "READONLY"} , 
 	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 416, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer14_out_dout sc_in sc_lv 416 signal 0 } 
	...
	{ layer16_out_din sc_out sc_lv 416 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer14_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":416, "type": "signal", "bundle":{"name": "layer14_out", "role": "dout" }} , 
 	...
 	{ "name": "layer16_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":416, "type": "signal", "bundle":{"name": "layer16_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer14_out { ap_fifo {  { layer14_out_dout fifo_port_we 0 416 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer14_out_fifo_cap fifo_update 0 2 }  { layer14_out_empty_n fifo_status 0 1 }  { layer14_out_read fifo_data 1 1 } } }
	layer16_out { ap_fifo {  { layer16_out_din fifo_port_we 1 416 }  { layer16_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer16_out_fifo_cap fifo_update 0 2 }  { layer16_out_full_n fifo_status 0 1 }  { layer16_out_write fifo_data 1 1 } } }
}
