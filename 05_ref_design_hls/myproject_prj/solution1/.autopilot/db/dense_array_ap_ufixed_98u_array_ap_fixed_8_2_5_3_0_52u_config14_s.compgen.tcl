...
set id 614
set name myproject_mux_987_8_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_dense_array_ap_ufixed_98u_array_ap_fixed_8_2_5_3_0_52u_config14_s_w14_V_ROM_Abgk BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer13_out_dout { I 784 vector } layer13_out_num_data_valid { I 2 vector } layer13_out_fifo_cap { I 2 vector } layer13_out_empty_n { I 1 bit } layer13_out_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer14_out_din { O 416 vector } layer14_out_num_data_valid { I 2 vector } layer14_out_fifo_cap { I 2 vector } layer14_out_full_n { I 1 bit } layer14_out_write { O 1 bit } } \
} "
}
