set moduleName relu_array_ap_fixed_98u_array_ap_ufixed_8_2_4_0_0_98u_relu_config13_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {relu<array<ap_fixed,98u>,array<ap_ufixed<8,2,4,0,0>,98u>,relu_config13>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer11_out int 784 regular {fifo 0 volatile }  }
	{ layer13_out int 784 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer11_out", "interface" : "fifo", "bitwidth" : 784, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 784, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer11_out_dout sc_in sc_lv 784 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 784 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer11_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":784, "type": "signal", "bundle":{"name": "layer11_out", "role": "dout" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":784, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer11_out { ap_fifo {  { layer11_out_dout fifo_port_we 0 784 }  { layer11_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer11_out_fifo_cap fifo_update 0 2 }  { layer11_out_empty_n fifo_status 0 1 }  { layer11_out_read fifo_data 1 1 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_port_we 1 784 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_full_n fifo_status 0 1 }  { layer13_out_write fifo_data 1 1 } } }
}
