...
entity myproject_fifo_w48_d1936_A is
    generic (
...
architecture arch of myproject_fifo_w48_d1936_A is

    -- component
    component myproject_fifo_w48_d1936_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w48_d1936_A_ram : myproject_fifo_w48_d1936_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity myproject_fifo_w48_d1936_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 48;
        ADDR_WIDTH  : integer := 11;
...
architecture arch of myproject_fifo_w48_d1936_A_ram is
